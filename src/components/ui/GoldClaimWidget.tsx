    ...
    <div className="pointer-events-auto fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      ...
      {open && (
        <div className="mb-1 w-56 border border-[var(--b0)] bg-[#0d1520]/95 shadow-2xl backdrop-blur-sm">
          <div className="relative border-b border-[var(--b0)] px-4 py-3">
            ...
            <button
              ...
              aria-label="Close"
              className="absolute right-3 top-1/2 -translate-y-1/2 flex h-6 w-6 items-center justify-center text-[var(--silver-3)] transition hover:text-[var(--silver-0)]">
