-- Refresh PostgREST schema cache for record_kingdom_visit function
-- This fixes "Could not find the function in the schema cache" error

-- Force schema cache refresh by recreating with same signature
